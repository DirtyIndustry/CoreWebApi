...
{
    public class RedisCache : IDistributedRedisCache, IDisposable
    {
        // KEYS[1] = = key
        ...
        public void UseDatabase(int databaseNumber)
        {
            if (databaseNumber > 16)
            {
            ...
            try
            {
                _cache = _connection.GetDatabase(databaseNumber);
            }
            finally
            {
                _connectionLock.Release();
